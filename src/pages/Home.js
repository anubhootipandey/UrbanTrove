  ...
  return (
    <>
      ...
      <div className="bg-blue-50 w-full h-auto">
        <img className="w-[1500px] h-[600px] mt-1 object-cover items-center hidden md:block animate-fadeIn" src="https://images.pexels.com/photos/953864/pexels-photo-953864.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
        <img className="w-full md:hidden animate-fadeIn" src="https://images.pexels.com/photos/953864/pexels-photo-953864.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
      </div>
      <div className="h-auto w-100 flex flex-wrap flex-col items-center text-center p-10 animate-fadeIn">
        ...
        <div className="w-full bg-blue-900 flex flex-wrap justify-evenly">
          <div className="bg-white mt-8 w-46 flex flex-col items-center mb-12 transform transition-transform hover:scale-105">
            ...
            <p className="text-m mb-2 font-bold text-yellow-500">₹256.9</p>
          </div>
          <div className="bg-white mt-8 w-46 flex flex-col items-center mb-12 transform transition-transform hover:scale-105">
            ...
            <p className="text-xl font-bold text-blue-700 mb-2">Tote Bag</p>
            <p className="text-m mb-2 font-bold text-yellow-500">₹220.5</p>
          </div>
          <div className="bg-white mt-8 w-46 flex flex-col items-center mb-12 transform transition-transform hover:scale-105">
            ...
            <p className="text-xl font-bold text-blue-700 mb-2">Tote bag</p>
            <p className="text-m mb-2 font-bold text-yellow-500">₹234.0</p>
          </div>
        </div>
      </div>
      <div className="h-auto w-100 flex flex-wrap flex-col items-center text-center p-10 animate-fadeIn">
        ...
        <div className="w-[90%] h-auto flex flex-wrap justify-around">
          <div className="w-64 bg-blue-900 flex flex-col items-center mb-12 border-2 p-2 transform transition-transform hover:scale-105">
          ...
          <div className="w-64 bg-blue-900 flex flex-col items-center mb-12 p-2 transform transition-transform hover:scale-105">
      ...
      <div className="h-auto w-100 flex flex-wrap flex-col items-center text-center p-10 bg-gray-100 animate-fadeIn">
        <div className="w-full h-auto flex flex-wrap flex-col items-center">
          <p className="text-indigo-800 font-bold text-3xl md:text-4xl text-center mb-4">
            Subscribe to our Newsletter
          </p>
          <form className="w-full md:w-1/2 flex flex-col items-center">
            <input
              type="email"
              placeholder="Enter your email"
              className="p-2 mb-4 w-3/4 border-2 border-gray-300 rounded-md"
            />
            <button className="bg-blue-900 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors">
              Subscribe
            </button>
          </form>
        </div>
